...
def test_call_threat_intel_agent_return_type(mock_post):
    ...
    result = call_threat_intel_agent("Ransomware attack on healthcare systems.")
...
def test_call_threat_intel_agent_returns_analysis_field(mock_post):
    ...
    mock_post.return_value = _mock_post_response(analysis="MITRE ATT&CK: T1566.001 Spearphishing.")
...
def test_call_threat_intel_agent_missing_analysis_key(mock_post):
    ...
    result = call_threat_intel_agent("test incident")
